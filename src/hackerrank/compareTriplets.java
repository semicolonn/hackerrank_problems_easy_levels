...
public class compareTriplets {
	 ...
	 * a = [1, 2, 3] b = [3, 2, 1]
	 * 
	 * For elements *0*, Bob is awarded a point because a[0] . For the equal
	 * elements a[1] and b[1], no points are earned. Finally, for elements 2, a[2] >
	 * b[2] so Alice receives a point.
	 * 
	 ...
	 * point.
	 * 
	 * Alice's comparison score is , and Bob's comparison score is . Thus, we return
	 * the array
	 * 
	 * .
	 * 
	 ...
	 * and so Alice receives two points. The return array is .
	 */
	...
	private static List<Integer> compareTriplets(List<Integer> a, List<Integer> b) {
		int a_counter = 0;
		int b_counter = 0;
		List<Integer> earnedPoints = new ArrayList<>();
		...
		earnedPoints.add(a_counter);
		earnedPoints.add(b_counter);
		return earnedPoints;
	}	//end of the function
